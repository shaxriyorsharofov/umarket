    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total', djmoney.models.fields.MoneyField(blank=True, decimal_places=2, default=Decimal('0'), default_currency='UZS', max_digits=12, verbose_name='Total price of an order')),
                ('status', models.CharField(choices=[('created', 'Created'), ('paid', 'Paid'), ('delivered', 'Delivered')], default='created', max_length=64, verbose_name='Status of an order')),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('cart', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='cart.Cart', verbose_name='Cart of the order')),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='customer_orders', to='accounts.Customer', verbose_name='Order for a customer')),
                ('driver', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='driver_orders', to='accounts.Driver', verbose_name='Driver for an order')),
            ],
            options={
                'ordering': ['-created_at'],
            },
