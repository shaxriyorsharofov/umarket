...
class DriverMore(models.Model):
    ...
    # region = models.CharField(choices=Regions.choices, verbose_name="Working region of a driver")
    # is_accepted_product = models.BooleanField(default=False, verbose_name="whether driver accepted product")
